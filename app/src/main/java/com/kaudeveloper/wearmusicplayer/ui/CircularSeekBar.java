...
public class CircularSeekBar extends View {
	 ...
	 */
	protected final float MIN_TOUCH_TARGET_DP = 64;

	// Default values
	protected static final float DEFAULT_CIRCLE_X_RADIUS = 100f;
	protected static final float DEFAULT_CIRCLE_Y_RADIUS = 100f;
	protected static final float DEFAULT_POINTER_RADIUS = 2f;
	protected static final float DEFAULT_POINTER_HALO_WIDTH = 1f;
	protected static final float DEFAULT_POINTER_HALO_BORDER_WIDTH = 0;
	protected static final float DEFAULT_CIRCLE_STROKE_WIDTH = 2f;
	protected static final float DEFAULT_START_ANGLE = 300f; // Geometric (clockwise, relative to 3 o'clock)
	protected static final float DEFAULT_END_ANGLE = 240f; 
	 ...
	 */
	protected RectF myCircleRectF = new RectF();

	/**
	 * Holds the color value for {@code mPointerPaint} before the {@code Paint} instance is created.
	 */
	protected int myPointerColor = DEFAULT_POINTER_COLOR;
	...
	protected void initAttributes(TypedArray attrArray) {
		...
		myPointerColor = attrArray.getColor(R.styleable.CircularSeekBar_pointer_color, DEFAULT_POINTER_COLOR);
	...
	protected void initPaints() {
		...
		mPointerPaint.setColor(myPointerColor);
	...
	protected void initPaths() {
		...
		mCirclePath.addArc(myCircleRectF, mStartAngle, mTotalCircleDegrees);

		mCircleProgressPath = new Path();
		mCircleProgressPath.addArc(myCircleRectF, mStartAngle, mProgressDegrees);
	}
	...
	protected void initRects() {
		myCircleRectF.set(-mCircleWidth, -mCircleHeight, mCircleWidth, mCircleHeight);
	}
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		float distanceX = myCircleRectF.centerX() - x;
		float distanceY = myCircleRectF.centerY() - y;
	...
	protected Parcelable onSaveInstanceState() {
		...
		state.putInt("myPointerColor", myPointerColor);
	...
	protected void onRestoreInstanceState(Parcelable state) {
		...
		myPointerColor = savedState.getInt("myPointerColor");
