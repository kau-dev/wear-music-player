...
import com.kaudeveloper.wearmusicplayer.ui.MainActivity;
...
//        this.dataSourceFactory = new CacheDataSourceFactory(cache, httpDataSourceFactory, CacheDataSource.FLAG_BLOCK_ON_CACHE | CacheDataSource.FLAG_IGNORE_CACHE_ON_ERROR);
        ...
        musicRepository.addFilesToArray(getString(R.string.path));
    ...
    public void prepareToPlayBYmenuPosition(int menuPosition) {
        int currentState = PlaybackStateCompat.STATE_STOPPED;
        com.kaudeveloper.wearmusicplayer.service.Track track = musicRepository.getBymenuPosition(menuPosition);
        if (track == null) {
            return;
        }
        ...
        currentUri = uri;
        ExtractorMediaSource mediaSource = new ExtractorMediaSource.Factory(dataSourceFactory).createMediaSource(currentUri);
        exoPlayer.prepare(mediaSource);
        // }
    }

    public int getMenuPosition() {
        return musicRepository.getArraylist().indexOf(musicRepository.getCurrent());
    }

    public long getCurrentPosition() {
        return exoPlayer.getCurrentPosition();
    }
    private void updateMetadataFromTrack(com.kaudeveloper.wearmusicplayer.service.Track track) {
        ...
        metadataBuilder.putString(MediaMetadataCompat.METADATA_KEY_DISPLAY_TITLE, track.getName());
    ...
    private MediaSessionCompat.Callback mediaSessionCallback = new MediaSessionCompat.Callback() {
        ...
        public void onPlay() {
            if (!exoPlayer.getPlayWhenReady()) {
                ...
                com.kaudeveloper.wearmusicplayer.service.Track track = musicRepository.getCurrent();
                if (track == null) {
                    return;
                }
                updateMetadataFromTrack(track);
        ...
        public void onSkipToNext() {
            ...
            com.kaudeveloper.wearmusicplayer.service.Track track = musicRepository.getNext();
            if (track == null) {
                return;
            }
            updateMetadataFromTrack(track);
        ...
        public void onSkipToPrevious() {
            com.kaudeveloper.wearmusicplayer.service.Track track = musicRepository.getPrevious();
            if (track == null) {
                return;
            }
            updateMetadataFromTrack(track);
